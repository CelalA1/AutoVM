...
class Datastore extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['server_id', 'space', 'is_default', 'vsan', 'is_public'], 'required'],
            [['uuid', 'value', 'pool_name', 'pool_path'], 'safe'],
    ...
    {
        return [
            self::SCENARIO_DEFAULT => ['server_id', 'uuid', 'value', 'space', 'pool_name', 'pool_path', 'is_default', 'vsan', 'is_public'],
        ];
    }
